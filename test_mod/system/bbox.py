...
COLOR_NAME_TO_RGB = dict(
    ...
    orchid=((153,50,204), (250,235,215)),
    brown=((139,69,19), (255,240,245)),
    pink=((255,192,203), (205,133,63)),
    lavender=((255,240,245), (119,136,153)),
    chocolate=((210,105,30), (255,248,220)),
    turquoise=((0,206,209), (220,20,60)),
    gold = ((255,215,0), (0,0,205)),
    magenta=((139,0,139), (144,238,144)),
    almond=((255,235,205), (47,79,79))
)
